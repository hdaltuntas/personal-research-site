  ...
  const paperSeries = [
    {
      ...
      papers: [
        {
          id: 1,
          title: 'Investigation of the optimum modification parameters for SBS-modified asphalt nanocomposites',
          journal: 'Road Materials and Pavement Design',
          year: 2026,
          status: 'Published',
          doi: 'https://doi.org/10.1080/14680629.2026.2646524',
          pdf: '',
          tags: ['Nanoclay', 'SBS', 'modified bitumen', 'SBS-modified asphalt nanocomposite', 'asphalt mixture'],
        },
        {
          id: 2,
          title: 'Investigation Of Wheel Tracking And Fatigue Resistance Performance of Nanoclay/Sbs/Bitumen Nanocomposites',
          journal: '9th National Asphalt Symposium and Exhibition',
          year: 2025,
          status: 'Published',
          doi: '',
          pdf: '',
        ...
        {
          id: 3,
          title: 'Reaktif Polimer Modifiye Bitümlerin Kürleme Sürelerinin Deformasyon ve Çatlama Davranışına Etkisi',
          journal: 'Recep Tayyip Erdoğan Üniversitesi Fen ve Mühendislik Bilimleri Dergisi',
          year: 2024,
          status: 'Published',
          doi: 'https://doi.org/10.53501/rteufemud.1569929',
          pdf: '',
          tags: ['Kürleme süresi', 'polimer modifiye bitüm', 'elvax', 'elvaloy', 'DSR', 'BBR'],
        },
        {
          id: 4,
          title: 'Comparison of SBS and Elvax/Elvaloy modified asphalt mixtures',
          journal: 'Proceedings of the 3rd International Civil Engineering and Architecture Conference Volume 1: Civil Engineering',
          year: 2023,
          status: 'Published',
          doi: 'https://doi.org/10.31462/icearc.2023.sme852',
          pdf: '',
          tags: [],
        },
        {
          id: 5,
          title: 'Planning and Designing the Izmir Bay Crossing and Connections',
          journal: 'SEE Tunnel:Promoting Tunneling in SEE Region ITA WTC 2015 Congress and 41st General Assembly',
          year: 2015,
          status: 'Published',
          doi: '',
          pdf: '',
